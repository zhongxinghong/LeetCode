    ...
    bool hasValidPath(vector<vector<int>>& grid)
    {
        ...
        while (!st.empty())
        {
            ...
            for (i = 0; i < 2; ++i)
            {
                ...
                case 1:
                    if (tp == 1 ||
                        tp == 3 && ISR(dx, dy) || tp == 4 && ISL(dx, dy) ||
                        tp == 5 && ISR(dx, dy) || tp == 6 && ISL(dx, dy))
                        goto ST_PUSH;
                    break;
                case 2:
                    if (tp == 2 ||
                        tp == 3 && ISU(dx, dy) || tp == 4 && ISU(dx, dy) ||
